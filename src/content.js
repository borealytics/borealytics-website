export const content = {
  en: {
    ...
    mission: {
      title: "Our Mission",
      text: "At Borealytics, we help SMEs and municipal organizations master their data. Our mission is to simplify access and use of your information to transform your challenges into strategic opportunities.",
      points: [
        "Structuring your data: For better organization and accessibility.",
        "Providing automation tools: For efficiency gains.",
        "Proposing Business Intelligence solutions: For agile and informed decisions.",
        "Offering personalized coaching: To strengthen your internal skills.",
        "Proposing AI solutions: To optimize analysis and decision-making."
      ]
    },
    vision: {
      title: "Our Vision",
      text: "We aspire to a future where data-driven decision-making is intuitive, integrated, and a driver of local prosperity. We are your trusted partner, building relationships based on trust and expertise."
    },
    values: {
      title: "Our Values",
      list: [
        { title: "Pedagogy", desc: "Transferring knowledge to build sustainable autonomy." },
        { title: "Pragmatism", desc: "Concrete solutions adapted to your reality." },
        { title: "Partnership", desc: "We succeed with our clients, not just for them." },
        { title: "Integrity", desc: "Strict confidentiality and honest recommendations." },
        { title: "Adaptability", desc: "Methods adapted to your size, budget, and maturity." }
      ]
    },
    contact: {
      title: "Contact Us",
